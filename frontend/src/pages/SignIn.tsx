              ...
              <form className="space-y-6" onLoad={() => setIsLoaded(true)}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-right">
                    <a href="/forgot-password" className="text-sm text-ninja-white/60 hover:text-ninja-green transition-colors">
                      Forgot Password?
                    </a>
                  </div>
                </div>
                ...
                <div className="text-center text-sm text-ninja-white/60">
                  ...
                  <a href="/signup" className="text-ninja-green hover:text-ninja-white transition-colors">
                    Sign Up
                  </a>
                </div>
              </form>
