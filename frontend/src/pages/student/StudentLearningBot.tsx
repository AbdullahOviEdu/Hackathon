              ...
              <div className="p-4 border-t border-ninja-white/10">
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className={`px-4 rounded-xl font-medium transition-all duration-300 ${
                      !input.trim() || isLoading
                        ? 'bg-ninja-black/30 text-ninja-white/20'
                        : 'bg-gradient-to-r from-ninja-purple to-ninja-green text-ninja-white'
                    }`}
                  >
